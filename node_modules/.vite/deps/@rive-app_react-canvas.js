...
var require_dist = __commonJS({
  "node_modules/@rive-app/react-canvas/dist/index.js"(exports) {
    ...
    var l = globalThis.ResizeObserver || c;
    var f = void 0 !== globalThis.ResizeObserver;
    var d = !f;
    function v(t2, n2) {
      void 0 === n2 && (n2 = true);
      ...
      e.useEffect(function() {
        if ("undefined" != typeof window && n2) {
          ...
          return d && (e2(), window.addEventListener("resize", e2)), function() {
            return window.removeEventListener("resize", e2);
          };
        }
      }, []);
      var a2, s2, u2, c2 = e.useRef(new l((a2 = function(e2) {
        f && o2({ width: e2[e2.length - 1].contentRect.width, height: e2[e2.length - 1].contentRect.height });
      }, s2 = 0, u2 = 0, function() {
        for (var e2 = this, t3 = [], n3 = 0; n3 < arguments.length; n3++) t3[n3] = arguments[n3];
        clearTimeout(u2), u2 = window.setTimeout(function() {
      ...
      return e.useEffect(function() {
        ...
        if (n2) {
          var i3 = t2.current;
          return t2.current && f && e2.observe(t2.current), function() {
            e2.disconnect(), i3 && f && e2.unobserve(i3);
          };
        }
        e2.disconnect();
      }, [t2, c2]), r2;
    ...
    function b(t2) {
      var n2 = t2.riveLoaded, i2 = void 0 !== n2 && n2, r2 = t2.canvasElem, o2 = t2.containerRef, a2 = t2.options, s2 = void 0 === a2 ? {} : a2, c2 = t2.onCanvasHasResized, l2 = t2.artboardBounds, f2 = p(s2), d2 = e.useState({ height: 0, width: 0 }), h2 = d2[0], b2 = h2.height, w2 = h2.width, y2 = d2[1], g2 = e.useState({ height: 0, width: 0 }), m2 = g2[0], R2 = m2.height, C2 = m2.width, E2 = g2[1], O = e.useState(true), x = O[0], T = O[1], P = f2.fitCanvasToArtboardHeight, L = f2.shouldResizeCanvasToContainer, S = f2.useDevicePixelRatio, k = f2.customDevicePixelRatio, M = v(o2, L), j = function(t3) {
        var n3 = t3 || u(), i3 = e.useState(n3), r3 = i3[0], o3 = i3[1];
        return e.useEffect(function() {
      ...
      }(k), z = null != l2 ? l2 : {}, H = z.maxX, I = z.maxY, D = e.useCallback(function() {
      ...
      e.useEffect(function() {
        if (L && o2.current && i2) {
          ...
          if (r2) {
            var s3 = t3 !== w2 || n3 !== b2;
            if (f2.fitCanvasToArtboardHeight && s3 && (o2.current.style.height = n3 + "px", a3 = true), f2.useDevicePixelRatio) {
              if (s3 || (t3 * j !== C2 || n3 * j !== R2)) {
                var u2 = j * t3, l3 = j * n3;
                r2.width = u2, r2.height = l3, r2.style.width = t3 + "px", r2.style.height = n3 + "px", E2({ width: u2, height: l3 }), a3 = true;
              }
            } else s3 && (r2.width = t3, r2.height = n3, E2({ width: t3, height: n3 }), a3 = true);
            y2({ width: t3, height: n3 });
          }
          c2 && (x || a3) && c2 && c2(), x && T(false);
        }
      }, [r2, o2, M, j, D, x, T, R2, C2, b2, w2, c2, L, P, S, i2]), e.useEffect(function() {
        E2({ width: 0, height: 0 });
      }, [r2]);
    }
    var w;
    ...
    var g = globalThis.IntersectionObserver || y;
    var m = function() {
      function e2() {
        var e3 = this;
    ...
    function C(e2) {
      var t2 = e2.setContainerRef, n2 = e2.setCanvasRef, a2 = e2.className, s2 = void 0 === a2 ? "" : a2, u2 = e2.style, c2 = e2.children, l2 = o(e2, ["setContainerRef", "setCanvasRef", "className", "style", "children"]), f2 = r({ width: "100%", height: "100%" }, u2);
      return i.default.createElement("div", r({ ref: t2, className: s2 }, !s2 && { style: f2 }), i.default.createElement("canvas", r({ ref: n2, style: { verticalAlign: "top", width: 0, height: 0 } }, l2), c2));
    }
    function E(n2, o2) {
      void 0 === o2 && (o2 = {});
      var a2 = e.useState(null), s2 = a2[0], u2 = a2[1], c2 = e.useRef(null), l2 = e.useState(null), f2 = l2[0], d2 = l2[1], v2 = Boolean(n2), h2 = p(o2), w2 = e.useCallback(function() {
        f2 && (f2.startRendering(), f2.resizeToCanvas());
      }, [f2]);
      b({ riveLoaded: !!f2, canvasElem: s2, containerRef: c2, options: h2, onCanvasHasResized: w2, artboardBounds: null == f2 ? void 0 : f2.bounds });
      var y2 = e.useCallback(function(e2) {
        null === e2 && s2 && (s2.height = 0, s2.width = 0), u2(e2);
      }, []);
      e.useEffect(function() {
        if (s2 && n2 && null == f2) {
          var e2 = h2.useOffscreenRenderer, i2 = new t.Rive(r(r({ useOffscreenRenderer: e2 }, n2), { canvas: s2 }));
          i2.on(t.EventType.Load, function() {
            s2 ? d2(i2) : i2.cleanup();
          });
        }
      }, [s2, v2, f2]);
      var g2 = e.useCallback(function(e2) {
        c2.current = e2;
      }, []), m2 = { observe: e.useCallback(function(e2, t2) {
        R().registerCallback(e2, t2);
      }, []), unobserve: e.useCallback(function(e2) {
        R().removeCallback(e2);
      }, []) }, E2 = m2.observe, O = m2.unobserve;
      e.useEffect(function() {
        var e2, t2 = false, n3 = function() {
          if (s2 && t2) {
            var e3 = s2.getBoundingClientRect();
            e3.width > 0 && e3.height > 0 && e3.top < (window.innerHeight || document.documentElement.clientHeight) && e3.bottom > 0 && e3.left < (window.innerWidth || document.documentElement.clientWidth) && e3.right > 0 && (null == f2 || f2.startRendering(), t2 = false);
          }
        };
        return s2 && false !== h2.shouldUseIntersectionObserver && E2(s2, function(i2) {
          i2.isIntersecting ? f2 && f2.startRendering() : f2 && f2.stopRendering(), t2 = !i2.isIntersecting, clearTimeout(e2), i2.isIntersecting || 0 !== i2.boundingClientRect.width || (e2 = setTimeout(n3, 10));
        }), function() {
          s2 && O(s2);
        };
      }, [E2, O, f2, s2, h2.shouldUseIntersectionObserver]), e.useEffect(function() {
        return function() {
          f2 && (f2.cleanup(), d2(null));
        };
      }, [f2, s2]);
      var x = null == n2 ? void 0 : n2.animations;
      e.useEffect(function() {
        f2 && x && (f2.isPlaying ? (f2.stop(f2.animationNames), f2.play(x)) : f2.isPaused && (f2.stop(f2.animationNames), f2.pause(x)));
      }, [x, f2]);
      var T = e.useCallback(function(e2) {
        return i.default.createElement(C, r({ setContainerRef: g2, setCanvasRef: y2 }, e2));
      }, [y2, g2]);
      return { canvas: s2, container: c2.current, setCanvasRef: y2, setContainerRef: g2, rive: f2, RiveComponent: T };
    }
    exports.default = function(e2) {
      var t2 = e2.src, n2 = e2.artboard, a2 = e2.animations, s2 = e2.stateMachines, u2 = e2.layout, c2 = e2.useOffscreenRenderer, l2 = void 0 === c2 || c2, f2 = e2.shouldDisableRiveListeners, d2 = void 0 !== f2 && f2, v2 = e2.shouldResizeCanvasToContainer, h2 = void 0 === v2 || v2, p2 = e2.automaticallyHandleEvents, b2 = void 0 !== p2 && p2, w2 = e2.children, y2 = o(e2, ["src", "artboard", "animations", "stateMachines", "layout", "useOffscreenRenderer", "shouldDisableRiveListeners", "shouldResizeCanvasToContainer", "automaticallyHandleEvents", "children"]), g2 = E({ src: t2, artboard: n2, animations: a2, layout: u2, stateMachines: s2, autoplay: true, shouldDisableRiveListeners: d2, automaticallyHandleEvents: b2 }, { useOffscreenRenderer: l2, shouldResizeCanvasToContainer: h2 }).RiveComponent;
      return i.default.createElement(g2, r({}, y2), w2);
    }, exports.useResizeCanvas = b, exports.useRive = E, exports.useRiveFile = function(n2) {
      var i2 = this, r2 = e.useState(null), o2 = r2[0], u2 = r2[1], c2 = e.useState("idle"), l2 = c2[0], f2 = c2[1];
      return e.useEffect(function() {
        var e2 = null;
          ...
          return s(this, function(i3) {
            try {
              f2("loading"), (e2 = new t.RiveFile(n2)).init(), e2.on(t.EventType.Load, function() {
                null == e2 || e2.getInstance(), u2(e2), f2("success");
      ...
      var a2 = e.useState(null), s2 = a2[0], u2 = a2[1];
      return e.useEffect(function() {
        function e2() {
          if (n2 && i2 && r2 || u2(null), n2 && i2 && r2) {
            var e3 = n2.stateMachineInputs(i2);
            if (e3) {
              var t2 = e3.find(function(e4) {
                return e4.name === r2;
              });
              void 0 !== o2 && t2 && (t2.value = o2), u2(t2 || null);
            }
          } else u2(null);
        }
